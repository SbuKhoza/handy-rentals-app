      ...
      <div className="min-h-screen pt-16 md:pt-20 flex items-center justify-center bg-muted/30 px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mt-6 mb-2">Create an account</h1>
            <p className="text-muted-foreground">Join Rent4Hire and start renting today</p>
          </div>
