...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Handle login - will integrate with Firebase
    console.log("Login:", { mode, email, phone, password });
  };

  return (
    <Layout hideFooter>
      <div className="min-h-screen pt-16 md:pt-20 flex items-center justify-center bg-muted/30 px-4 py-12">
        <div className="w-full max-w-md">
          {/* Logo */}
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2">
              <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center">
                <span className="text-secondary-foreground font-bold text-2xl">R</span>
              </div>
            </Link>
            <h1 className="text-2xl font-bold text-foreground mt-6 mb-2">Welcome back</h1>
            <p className="text-muted-foreground">Sign in to your Rent4Hire account</p>
          </div>
